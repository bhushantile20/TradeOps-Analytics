...
class RNNModel:
    """
    Simple RNN model implementation for BTC price prediction.
    """
    ...
    def _build_model(self):
        model = Sequential([
            SimpleRNN(self.units, return_sequences=True, input_shape=self.input_shape),
            Dropout(0.2),
    ...
    def prepare_data(self, data, lookback=24):
        """
        Prepares sequences for RNN training.
        """
    ...
    def save_model(self, path: str):
        ...
        print(f"RNN model and scalers saved to {path}")
    ...
    def load_model(self, path: str):
        ...
        print(f"RNN model and scalers loaded from {path}")
